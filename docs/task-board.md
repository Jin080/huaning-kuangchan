...
- T38B/T38C 可启动：后台其余管理页面与企业中心 Stitch 复刻，需基于 `docs/qa/stitch-full-replication-plan.md` 分批推进，并避免与 T32/T33 混做。
- T32/T33 属于上线必做能力；T32 已确认需要真实上传接口，应拆分为后端上传接口与前端拍品表单接入，不再只做本地选择占位。
