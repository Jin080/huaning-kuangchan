...
| T37 | TODO | 前端视觉 | 门户与详情页 Stitch 全面复刻 | T36 | 待启动 | 基于 T36 计划，优先复刻门户首页、公告/竞价/成交/资讯列表与详情等 PC 门户页面 |
| T38 | TODO | 前端视觉 | 后台与企业中心 Stitch 全面复刻 | T36 | 待排期 | 基于 T36 计划，复刻后台管理与企业中心页面视觉，同时保持真实 API 和现有业务交互 |

## 当前可并行任务

- T36 可启动：对 `stitch_document_to_webpage_generator/` 做全站页面效果盘点，形成复刻计划。
- T32/T33 属于上线必做能力；T36/T37/T38 属于视觉复刻链路，建议不要和认证、上传能力混做同一会话。

## 当前必须串行任务

- T37/T38 应等待 T36 盘点完成后再启动，避免盲目大面积改样式导致遗漏或回归。
