...
- T38 可启动：后台与企业中心 Stitch 全面复刻，需基于 `docs/qa/stitch-full-replication-plan.md` 分批推进，并避免与 T32/T33 混做。
- T32/T33 属于上线必做能力；T37/T38 属于视觉复刻链路，建议不要和认证、上传能力混做同一会话。

## 当前必须串行任务

- T38 如继续大范围修改后台/企业中心样式，应先确认当前门户视觉分支已提交推送，避免同一批次混入 T32/T33 功能改动。
