...
const routes: Record<string, () => React.ReactNode> = {
  ...
  '/admin/lots/workflow': () => <LotWorkflowPage />,
  '/admin/lots/workflow/detail': () => <LotWorkflowDetailPage />,
  '/admin/lots/progress': () => <LotProgressPage />,
  '/admin/lots/bids': () => <LotBidDetailPage />,
  '/admin/auction-closing': () => <AuctionClosingPage />,
  '/admin/reviews': () => <ReviewCenterPage />,
  '/admin/reviews/lot-close': () => <LotCloseReviewPage />,
